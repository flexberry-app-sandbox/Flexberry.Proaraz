...
namespace IIS.Proaraz
{
    ...
    public class Карты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proaraz.ВидКарты fТипКарты;
        ...
        public virtual IIS.Proaraz.ВидКарты ТипКарты
        {
            get
            {
                ...
                IIS.Proaraz.ВидКарты result = this.fТипКарты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КартыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартыE", typeof(IIS.Proaraz.Карты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КартыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартыL", typeof(IIS.Proaraz.Карты));
                }
            }
        }
    }
