...
namespace IIS.Proaraz
{
    ...
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proaraz.Должности fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Proaraz.Должности Должности
        {
            get
            {
                ...
                IIS.Proaraz.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.Proaraz.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.Proaraz.Сотрудник));
                }
            }
        }
    }
